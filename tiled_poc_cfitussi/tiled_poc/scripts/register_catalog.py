...
def create_data_source(art_row):
    ...
    if artifact_type == "mh_curve":
    ...
    elif artifact_type == "rixs_map":
        data_shape = tuple(shape_default)   # (3125, 151, 40)

    elif artifact_type == "xps_spectrum":
        data_shape = (shape_default[0],) #(3125, 5000)
        ...
        data_shape = (shape_default[0],) #(5000)
...
def verify_registration(client):
    ...
    if keys:
        ...
        for k in ["F2_dd", "F2_dp", "F4_dd","G1_dp","G3_dp","Gam_c","sigma", "soc_c","soc_v_i","soc_v_n","tenDq","xoffset"]:
